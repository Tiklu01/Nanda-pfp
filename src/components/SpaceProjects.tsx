  ...
  const projects = [
    {
      ...
      demo: undefined,
      video:
        "https://res.cloudinary.com/dwt633pc6/video/upload/v1753042031/WhatsApp_Video_2025-07-13_at_19.17.25_oaaghu.mp4",
      image:
        "https://res.cloudinary.com/dwt633pc6/image/upload/v1753042668/efea7adf-9e52-4d06-8976-1f14c26fc9df.png",
    },
    {
      id: 2,
      title: "FitCircuit",
      description:
        "FitCircuit, an innovative platform, revolutionizes fitness and nutrition with AI-driven personalized workout plans, tailored meal plans, and real-time nutritional insights.",
      tags: [
        "NextJs",
        "TypeScript",
        "Chart.js",
      ...
      image:
        "https://res.cloudinary.com/dwt633pc6/image/upload/v1753044010/Screenshot_2025-02-23_at_1.12.10_PM_ongwxq.png",
    },
    {
      id: 3,
      title: "Event Planner 360",
      description:
        "An event management tool that provides CRUD operations and seamless integration with Stripe payment gateway.",
      ...
      video:
        "https://res.cloudinary.com/dwt633pc6/video/upload/v1753045495/1714494833485_rcbxup.mp4",
      image:
        "https://res.cloudinary.com/dwt633pc6/image/upload/v1753043193/eventplanner360_urxtgb.png",
    },
    {
      id: 4,
      title: "TechVerse 3.0",
      description:
        "Website for GNIT's Annual Technical Fest with Registration and Admin Dashboard capabilities.",
      ...
      image:
        "https://res.cloudinary.com/dwt633pc6/image/upload/v1753045805/69ce8456-4fe3-4675-969b-a974a87271fc.png",
    },
    {
      id: 5,
      title: "Car Price Regression Model",
      description:
        "A custom made Regression model from scratch (gradient descent, normalization) for Learning purposes.",
      tags: [
        "Python",
        "Machine Learning",
        "Pandas",
      ...
      demo: undefined,
      video:
        "https://res.cloudinary.com/dwt633pc6/video/upload/v1753046368/1723813784909_icvsbk.mp4",
    ...
    },
    {
      ...
      description:
        "A 3D shirt customizer made with OpenAI's DALL-E  and Three.js, allowing users to design and visualize custom shirts in real-time.",
      tags: ["R3F", "Three.js", "DALL-E", "javaScript"],
      github: "https://github.com/Tiklu01/Shirt-Customizer",
      demo: undefined,
      video:
        "https://res.cloudinary.com/dwt633pc6/video/upload/v1753045663/1698475698990_j1abbh.mp4",
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-8">
                <h3
                  className="font-funky text-2xl md:text-3xl text-black dark:text-white mb-4 transform -rotate-1"
                  style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
                >
                  {project.title}
                </h3>
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-black dark:bg-white text-white dark:text-black uppercase tracking-wider hover:bg-gray-800 dark:hover:bg-gray-200 transition-all transform hover:scale-105 hover:rotate-2 border-4 border-black dark:border-white"
                    style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
                  >
                  ...
                  {project.demo && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-6 py-3 bg-yellow-300 dark:bg-yellow-400 text-black uppercase tracking-wider hover:bg-yellow-400 dark:hover:bg-yellow-500 transition-all transform hover:scale-105 hover:-rotate-2 border-4 border-black dark:border-white"
                      style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
                    >
