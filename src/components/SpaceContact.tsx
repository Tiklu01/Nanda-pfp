    ...
    <section className="py-20 bg-gradient-to-br from-cyan-100 to-blue-100 dark:from-gray-900 dark:to-cyan-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2
            className="text-4xl md:text-7xl text-black dark:text-white mb-8 transform rotate-1 text-shadow-fun"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-800 border-4 border-black dark:border-white p-8 transform -rotate-1 hover:rotate-0 transition-transform shadow-xl">
              <h3
                className="text-2xl md:text-4xl text-black dark:text-white mb-6 transform rotate-1"
                style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
              >
                Get In Touch
              </h3>
            ...
            <div className="bg-white dark:bg-gray-800 border-4 border-black dark:border-white p-8 transform rotate-1 hover:rotate-0 transition-transform shadow-xl">
              <h4
                className="text-xl md:text-2xl text-black dark:text-white mb-6 transform -rotate-1"
                style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
              >
                Follow My Journey
              </h4>
          ...
          <div className="bg-white dark:bg-gray-800 border-4 border-black dark:border-white p-8 transform rotate-2 hover:rotate-0 transition-transform shadow-xl">
            <div className="text-center mb-8">
              <h4
                className="text-2xl md:text-4xl text-black dark:text-white mb-4 transform -rotate-1"
                style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
              >
                Send Transmission
              </h4>
              <p className="text-gray-700 dark:text-gray-200 font-bold">
                Launch your message into the digital cosmos!
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label
                    className="block text-sm mb-3 text-black dark:text-white uppercase tracking-wider"
                    style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
                  >
                    First Name *
                  </label>
                  <input
                    ...
                    className={`w-full px-6 py-4 border-4 focus:outline-none font-bold text-lg transition-colors ${
                      errors.firstName
                        ...
                        : "border-black dark:border-white bg-white dark:bg-gray-700 text-black dark:text-white"
                    }`}
              ...
              {submitStatus === "error" && Object.keys(errors).length > 0 && (
                <div className="bg-red-100 dark:bg-red-900 border-4 border-red-500 dark:border-red-400 p-4 text-center transform -rotate-1">
                  <p className="text-red-800 dark:text-red-200 font-bold">
                    ❌ Please fix the errors above before launching your message!
                  </p>
                </div>
              )}
            </form>
