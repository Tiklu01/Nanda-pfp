  ...
  const timelineEvents = [
    {
      ...
      location: "IEM Ashram",
      description: "Judged HackOLution 2k26 and mentored hackers with thier ideas.",
    ...
    },
    {
      ...
      location: "Asansol",
      description: "I served as a mentor at Hacktropica and later as a judge.",
    ...
    },
    {
      ...
      location: "GNIT, Kolkata",
      description:
        "Operated as Tech Lead for GNIT's annual technical fest, overseeing end-to-end tech execution and coordination.",
      image: "/tv1.JPG",
      type: "work",
      color: "bg-pink-300",
    },
    ...
    <section className="py-10 md:py-20 bg-gradient-to-br from-purple-100 to-blue-100 dark:from-gray-900 dark:to-blue-900 relative overflow-hidden">
      ...
      <div className="hidden lg:block absolute top-20 right-4 xl:right-20 animate-float">
        <svg
          ...
          height="60"
          viewBox="0 0 60 100"
          className="drop-shadow-lg lg:w-[60px] lg:h-[100px]"
        >
          {/* Rocket body */}
          ...
          {/* Flames */}
          <polygon
            points="20,90 30,95 40,90 35,100 25,100"
            fill="#ff4500"
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-8 md:mb-16">
          <h2
            className="font-funky text-4xl md:text-6xl lg:text-7xl text-black dark:text-white mb-4 md:mb-8 transform rotate-1 text-shadow-fun"
            ...
            <div className="hidden md:block w-full h-full">
              <svg width="8" height="100%" className="absolute" preserveAspectRatio="none">
                <defs>
                  ...
                  >
                    <path
                      d="M4,0 Q8,50 4,100 Q0,150 4,200"
                      stroke="#000"
                      strokeWidth="4"
                      fill="none"
              ...
              >
                ...
                <div className="md:hidden ml-16 space-y-4">
                  <div className="bg-white dark:bg-gray-800 border-4 border-black dark:border-white p-4 shadow-xl hover-lift transform rotate-1 hover:rotate-0">
                    ...
                    <h3
                      className="font-funky text-xl md:text-2xl text-black dark:text-white mb-2 transform rotate-1"
                      style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
                    >
                      {event.title}
                    </h3>
                    <p className="text-black dark:text-white font-black text-lg mb-2">
                      {event.company}
                    </p>
                    ...
                    <p className="text-gray-700 dark:text-gray-200 leading-relaxed font-semibold text-sm">
                      {event.description}
                    </p>
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    <h3
                      className="font-funky text-xl md:text-2xl lg:text-3xl text-black dark:text-white mb-3 transform rotate-1"
                      style={{ fontWeight: "900", fontFamily: "Bungee, Arial Black, sans-serif" }}
                    >
                      {event.title}
                    </h3>
                    <p className="text-black dark:text-white font-black text-lg lg:text-xl mb-2">
                      {event.company}
                    </p>
                    ...
                    <p className="text-gray-700 dark:text-gray-200 leading-relaxed font-semibold">
                      {event.description}
                    </p>
                  </div>
                </div>
                ...
                {/* Desktop Image */}
                <div
                  className={`hidden md:block md:w-5/12 ${index % 2 === 0 ? "md:pl-16" : "md:pr-16"}`}
                >
                  <div
