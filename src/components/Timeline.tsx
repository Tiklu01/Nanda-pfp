  ...
  const timelineEvents = [
    {
      ...
      description:
        "Leading development of enterprise-level applications and mentoring junior developers.",
      image:
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Achieved AWS Solutions Architect Associate certification, enhancing cloud expertise.",
      image:
    ...
    },
    {
      ...
      description:
        "Built scalable web applications from scratch, handling both frontend and backend development.",
      image:
    ...
    },
    {
      ...
      description:
        "Specialized in React.js development, creating modern and responsive user interfaces.",
      image:
          ...
          <div className="space-y-12">
            {timelineEvents.map((event, index) => (
              ...
              >
                {/* Timeline dot */}
                <div
                  className={`absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-gradient-to-r ${getColor(event.type)} rounded-full border-4 border-white shadow-lg z-10`}
                ></div>
                ...
                <div className={`w-5/12 ${index % 2 === 0 ? "pr-8 text-right" : "pl-8 text-left"}`}>
                  <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                    <div className="flex items-center gap-2 mb-3">
                      <div
                        className={`p-2 bg-gradient-to-r ${getColor(event.type)} rounded-full text-white`}
                      >
                        {getIcon(event.type)}
                      </div>
