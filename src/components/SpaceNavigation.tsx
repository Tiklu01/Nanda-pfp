        ...
        <div className="relative">
            ...
            <div className="relative animate-float">
              ...
              >
                ...
                <ellipse
                  ...
                  stroke="#000"
                  strokeWidth="2"
                  className="blob-1 dark:fill-cyan-400"
                />
                <ellipse
                  cx="30"
                  cy="18"
                  ...
                  stroke="#000"
                  strokeWidth="2"
                  className="blob-2 dark:fill-pink-400"
                />
                <ellipse
                  cx="30"
                  cy="15"
                  ...
                  stroke="#000"
                  strokeWidth="1.5"
                  className="blob-3 dark:fill-yellow-300"
                />
                ...
                />
                <polygon
                  points="22,31 38,31 35,40 25,40"
                  fill="#ffff00"
                  opacity="0.3"
                  className="animate-pulse-slow"
                />
          ...
          {isMenuOpen && (
            <div
              ...
              style={{
                boxShadow: "6px 6px 0px rgba(255,107,107,0.4), 12px 12px 0px rgba(255,255,0,0.2)",
              }}
            >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  {isDarkMode ? (
                    <svg
                      ...
                      height="20"
                      viewBox="0 0 24 24"
                      className="text-yellow-300 md:w-6 md:h-6"
                    >
                    ...
                    <svg
                      ...
                      height="20"
                      viewBox="0 0 24 24"
                      className="text-purple-800 md:w-6 md:h-6"
                    >
                      <path
