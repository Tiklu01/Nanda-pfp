  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500 rounded-full opacity-10 animate-spin"
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 flex flex-col items-center justify-center min-h-screen text-center">
        ...
        <p className="text-lg md:text-xl mb-12 max-w-2xl opacity-80 animate-fade-in-up delay-300">
          Crafting beautiful, functional experiences that bridge the gap between design and
          technology.
        </p>
        ...
        <div className="flex gap-6 mb-12 animate-fade-in-up delay-500">
          <a
            href="#"
            className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-all transform hover:scale-110 backdrop-blur-sm"
          >
