      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            I'm a passionate developer with a keen eye for design, dedicated to creating exceptional
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              established companies to bring innovative ideas to life. My passion lies in the
              intersection of design and technology, creating solutions that are both beautiful and
              functional.
            </p>
            <p className="text-gray-600 leading-relaxed">
              I believe in continuous learning and staying up-to-date with the latest technologies
              and design trends. Every project is an opportunity to push boundaries and create
